...
_DEFAULT_BENCHMARKS = {
    ...
    'education': {  # DB37/T 2671-2019《教育机构能源消耗定额标准》（原文逐页核验 2026-09-20）
        ...
        # 4452 的子类与 2671 的分档并非一一对应，映射关系：
        #   高等教育（本科及以上/专科）→ 高等院校 先进33/通用50
        #   中等教育（非寄宿/寄宿/职业）→ 中等教育学校 先进8/通用14（4452 只有"有住宿"一档）
        #   初等教育 → 4452 分"有住宿 8/11""无住宿 6.8/10.8"，本表取**有住宿**（平台单码分不出住宿制，见 remark）
        #   学前教育 → 幼儿园（无住宿）先进10.3/通用13.9
        #   其他教育 → 特殊教育学校 先进15/通用32.3
        'water_per_person': {
            '高等教育·本科及以上': (50, 33, 0),
            '高等教育·专科': (50, 33, 0),
            '中等教育·普通非寄宿制': (14, 8, 0),
