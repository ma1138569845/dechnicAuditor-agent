...
.. code-block:: yaml
    ...
    branding:
      agent_name: "DechnicAuditor Agent"  # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ DechnicAuditor "  # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "DechnicAuditor Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic DechnicAuditor — gold and kawaii",
        ...
        "branding": {
            "agent_name": "DechnicAuditor Agent",
            "welcome": "Welcome to DechnicAuditor Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ DechnicAuditor ",
            "prompt_symbol": "❯",
