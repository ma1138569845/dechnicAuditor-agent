...
_HERMES_BRANDING: Dict[str, str] = _branding(
    # FORK: our brand name + caduceus-mark glyph.
    "DechnicAuditor", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic DechnicAuditor — gold and kawaii",
