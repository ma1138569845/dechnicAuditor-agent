...
| W3 | 数据缺失如实标【待补充】却被 V3 判 P0 阻塞交付 | 已登记的数据缺失写入 `<项目>/missing_items.json` → V3 记 **P1 放行**；未登记占位仍 P0 | `ea-validation/SKILL.md`；当时的验证记录在**草稿区** `energy-audit-v2/_changes/T2-直跑验证记录.md`（**不在技能包内**） |
