# fixes
> 本文并入 `audit-info-tables-fix.md`、`collector-chain-fixes.md`（2026-09-18 瘦身合并第 5 组，原文件已归档至 `_archive/2026-09-18/energy-audit-report-qa/references/`）；内容逐字保留，仅统一标题层级。

---

## 审计信息三张表修复根因链（原 audit-info-tables-fix）
...
## 采集链路修复记录（原 collector-chain-fixes）
