...
泛化验证基线：**山东省立医院东院区**（医疗类）——医院项目验收点：医疗定额 DB37/T 2673-2019、单位开放床日用水量（医院 6 项指标体系下为 5.3.6，见 core/references/standards-values.md L208）、chapter3 医疗模板、特殊用能（大型医疗设备/净化空调/消毒蒸汽）剔除口径。
