...
TOOLSETS = {
    ...
    "energy_audit": _ts(
        "能源审计 PG 数据库查询、RAG 检索与报告仿写：项目、建筑、设备、能耗、表具计量、同类报告仿写生成 Word 等",
        [
            ...
            "energy_audit_imitate_paragraph", "energy_audit_imitate_report",
        ],
    ),
    "desktop_ui": _ts(
    ...
    "office_editor": _ts(
        "Office editing via the local editor_sdk (Tencent Docs AI Engine) — "
        "create/open/edit/save .docx/.xlsx/.pptx, live preview in the desktop pane (office_editor tools)",
        [
