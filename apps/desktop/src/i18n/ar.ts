...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsDesc:
        'فقاعة صغيرة تشير إلى جزء من التطبيق، تظهر أحيانًا أثناء الخمول ومن DechnicAuditor عند الحاجة. إغلاق نصيحة يزيلها نهائيًا.',
      tipsReset: count => `استعادة ${count} نصيحة مغلقة`,
      toursTitle: 'جولات إرشادية',
      toursDesc: 'دع DechnicAuditor يرشدك في التطبيق، مع تعتيم الشاشة وإبراز كل خطوة.',
