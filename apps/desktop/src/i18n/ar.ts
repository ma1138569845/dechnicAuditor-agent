...
export const ar = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'جار تشغيل DechnicAuditor Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية DechnicAuditor الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية DechnicAuditor الخلفية أثناء بدء التشغيل.',
    ...
    failure: {
      title: 'تعذر تشغيل DechnicAuditor',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية DechnicAuditor أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateHermes: 'تحديث DechnicAuditor',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل DechnicAuditor Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر DechnicAuditor ردّك.',
      turnDoneTitle: 'أنهى DechnicAuditor',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات DechnicAuditor؟',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها DechnicAuditor). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون DechnicAuditor في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح DechnicAuditor سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان DechnicAuditor في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    searchPlaceholder: {
      about: 'حول DechnicAuditor Desktop',
    ...
    appearance: {
      title: 'المظهر',
      intro: 'خصص مظهر DechnicAuditor Desktop.',
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح DechnicAuditor.',
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ DechnicAuditor التفاعل مع رسائلك.',
      tipsTitle: 'نصائح داخل التطبيق',
      tipsDesc:
        // FORK: upstream's 30-day copy, branded.
        'نصائح تظهر أحيانًا من التطبيق وDechnicAuditor. تظهر كل نصيحة مرة واحدة. تُعطّل تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      tipsReset: count => `إظهار ${count} نصيحة مرة أخرى`,
      toursTitle: 'جولات إرشادية',
      toursDesc:
        'دع DechnicAuditor يرشدك في التطبيق مع إبراز كل خطوة. تُعطّل الجولات تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله DechnicAuditor — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق DechnicAuditor وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج DechnicAuditor إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف DechnicAuditor التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع DechnicAuditor قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل DechnicAuditor مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث DechnicAuditor نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول DechnicAuditor',
      ...
      automaticUpdatesDesc: 'اسمح لـ DechnicAuditor بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      loading: 'جار تحميل إعدادات DechnicAuditor...',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح DechnicAuditor.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل DechnicAuditor Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية DechnicAuditor تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق.',
      appliesTo: 'ينطبق على',
      ...
      localDesc: 'تشغيل خلفية DechnicAuditor خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      ...
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية DechnicAuditor بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      ...
      restartingMessage: 'سيعيد DechnicAuditor Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · DechnicAuditor ${version}` : ''}`,
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل DechnicAuditor تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل DechnicAuditor لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث DechnicAuditor لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك DechnicAuditor عند الانتهاء.',
    ...
    nav: {
      ...
      settings: {
        title: 'الإعدادات',
        detail: 'تكوين DechnicAuditor desktop'
      },
      skills: {
      ...
      knowledge: {
        title: 'قاعدة المعرفة',
        detail: 'تصفح قواعد المعرفة وإدارتها'
      },
      messaging: {
        title: 'المراسلة',
    ...
    hermesActiveSessions: (version, count) => `DechnicAuditor ${version} لديه ${count} جلسة نشطة`,
  ...
  cron: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل DechnicAuditor تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها DechnicAuditor تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من DechnicAuditor أن يفعل؟',
  ...
  knowledge: {
    title: 'قاعدة المعرفة',
    create: 'قاعدة معرفة جديدة',
    createTitle: 'إنشاء قاعدة معرفة',
    createDesc: 'سمِّ قاعدة المعرفة ثم ارفع المستندات للبحث والاستشهاد.',
    nameLabel: 'الاسم',
    namePlaceholder: 'تقارير تدقيق الطاقة',
    descLabel: 'الوصف',
    descPlaceholder: 'وصف اختياري',
    systemBases: 'قواعد معرفة النظام',
    userBases: 'قواعد معرفتي',
    system: 'نظام',
    noDescription: 'لا يوجد وصف',
    emptyTitle: 'لا توجد قواعد معرفة بعد',
    emptyDesc: 'أنشئ قاعدة معرفة لرفع المستندات وتشغيل الاسترجاع.',
    searchPlaceholder: 'البحث في قواعد المعرفة…',
    deleteConfirm: name => `حذف «${name}»؟ ستُزال المستندات في قاعدة المعرفة هذه.`,
    deleteDocConfirm: name => `حذف «${name}»؟`,
    deleteFolderConfirm: name => `حذف المجلد «${name}» ومستنداته؟`,
    created: 'تم إنشاء قاعدة المعرفة',
    deleted: 'تم الحذف',
    failedLoad: 'تعذر تحميل قواعد المعرفة',
    failedCreate: 'تعذر الإنشاء',
    failedDelete: 'تعذر الحذف',
    failedUpload: 'فشل الرفع',
    uploadSuccess: 'بدأ الرفع',
    upload: 'رفع',
    uploading: 'جارٍ الرفع…',
    folders: 'المجلدات',
    newFolder: 'مجلد جديد',
    folderHint: 'تجمع المجلدات المستندات داخل قاعدة المعرفة.',
    ...
    noDocumentsDesc: 'ارفع ملفات إلى هذا المجلد لفهرستها.',
    noChunks: 'لا توجد مقاطع بعد. قد يكون التحليل ما زال جارياً.',
    ...
    searchHint: 'البحث في قاعدة المعرفة هذه…',
    searchEmpty: 'أدخل استعلاماً لاسترجاع المقاطع المطابقة.',
    searchNoResults: 'لا توجد مقاطع مطابقة',
    searchAction: 'بحث',
    searching: 'جارٍ البحث…',
    score: 'الدرجة',
    untitled: 'بدون عنوان',
    noWikiTitle: 'لا توجد صفحات ويكي',
    noWikiDesc: 'تظهر صفحات الويكي بعد فهرسة قاعدة المعرفة.',
    statsTotal: 'المستندات',
    statsCompleted: 'مكتمل',
    statsProcessing: 'قيد المعالجة',
    statsFailed: 'فشل',
    statsOrphaned: 'يتيم',
    statsSize: 'الحجم الإجمالي',
    statusPending: 'معلق',
    statusProcessing: 'قيد المعالجة',
    statusCompleted: 'مكتمل',
    statusFailed: 'فشل',
    docsCount: count => `${count} مستند`,
    backToList: 'كل قواعد المعرفة',
    notFound: 'قاعدة المعرفة غير موجودة',
    nextPage: 'التالي',
    rangeOf: (start, end, total) => `${start}–${end} من ${total}`,
    generate: 'توليد',
    rebuild: 'إعادة البناء',
    rebuildConfirm: 'إعادة تحويل كل المستندات في قاعدة المعرفة هذه إلى متجهات؟ تستمر المهام الجارية وتُصفّ المهام الجديدة.',
    rebuildQueued: 'تم وضع إعادة البناء في قائمة الانتظار',
    folderWiki: 'ويكي المجلد',
    bulkWiki: 'ويكي بالجملة',
    hierarchicalWiki: 'ويكي هرمي',
    curateApproved: 'تنقيح الصفحات المعتمدة',
    llmConfirmTitle: 'يستخدم نموذج اللغة',
    llmConfirmBody: 'تستدعي هذه الخطوة نموذج اللغة وقد تستغرق وقتاً. المتابعة؟',
    actionStarted: 'بدأ',
    actionFailed: 'تعذر البدء',
    wikiSkipped: 'صفحة الويكي موجودة — تم التخطي',
    qualityUpdated: 'تم تحديث درجة الجودة',
    vectorize: 'تحويل إلى متجهات',
    revectorize: 'إعادة التحويل',
    summary: 'ملخص',
    graph: 'الرسم البياني',
    wiki: 'ويكي',
    generateWiki: 'إنشاء ويكي',
    generateSummary: 'إنشاء ملخص',
    buildGraph: 'بناء الرسم البياني',
    moreActions: 'المزيد',
    wikiConfirmTitle: 'إنشاء ويكي',
    wikiConfirmBody: 'كتابة صفحات ويكي من هذا المستند. افتح تبويب الويكي عند الجاهزية.',
    wikiCurateAfter: 'تنقيح بعد الإنشاء',
    wikiCurateAfterHint: 'ثم إعادة صياغة المسودة إلى صفحات مفاهيم. أبطأ ويستدعي النموذج مرة أخرى.',
    textExcerpt: 'مقتطف نصي',
    noSummary: 'لا يوجد ملخص بعد',
    noSummaryDesc: 'يمكن إنشاء ملخص من قائمة المزيد بعد فهرسة المستند.',
    chunkOff: 'غير مضمّن في البحث',
    previewTooLarge: 'الملف أكبر من أن يُعرض داخل اللوحة.',
    openPipeline: 'فتح',
    noPreview: 'لا تتوفر معاينة للملف.',
    searchModeVector: 'متجه',
    searchModeWiki: 'ويكي',
    searchModeGraph: 'رسم بياني',
    searchModeUnified: 'موحّد',
    reviewAll: 'كل المراجعات',
    reviewPending: 'معلق',
    reviewApproved: 'معتمد',
    reviewRejected: 'مرفوض',
    approve: 'اعتماد',
    reject: 'رفض',
    evaluateQuality: 'تقييم الجودة',
    quality: 'الجودة',
    entities: 'الكيانات',
    relationships: 'العلاقات',
    noGraphTitle: 'لا يوجد رسم بياني بعد',
    noGraphDesc: 'ابنِ رسماً بيانياً من مستند مكتمل لاستخراج الكيانات والعلاقات.',
    graphSearch: 'ابحث عن الكيانات…',
    graphFit: 'ملاءمة',
    graphHint: 'مرّر للتكبير · اسحب للتحريك · اسحب عقدة لتثبيتها',
    graphNeighbors: 'متصل',
    graphNoSelection: 'اختر عقدة لرؤية وصلاتها.',
    graphOrphan: 'لا توجد وصلات في هذا العرض.',
    graphCanvas: 'رسم المعرفة',
    graphResize: 'تغيير عرض اللوحة',
    noJobsTitle: 'لا توجد مهام',
    noJobsDesc: 'ستظهر هنا مهام التحويل والتنقيح.',
    jobTypeVectorize: 'تحويل إلى متجهات',
    jobTypeCurate: 'تنقيح',
    selectedCount: n => `${n} محدد`,
    bulkDeleteConfirm: 'حذف المستندات المحددة؟',
    deleteChunkConfirm: 'حذف هذا المقطع؟',
    editChunk: 'تحرير'
  },
  ...
  office: {
    ...
    status: {
      ...
      hintIdle: 'لا عمل كانبان أو مجدول جارٍ',
      hintBusy: 'يعالج مهمة كانبان أو مجدولة',
      hintOffline: 'بوابة المراسلة لهذا الملف غير قيد التشغيل',
      hintGatewayOff: 'بوابة المراسلة متوقفة (دردشة سطح المكتب ما زالت تعمل)'
    },
    ledger: {
      title: 'سجل المهام',
      filterAll: 'الكل',
    ...
    activity: {
      visit: (visitor, host) => `${visitor} زار ${host}`,
      tour: (visitor, count) => `${visitor} طاف على ${count} مكاتب`,
      setState: (profile, state) => `${profile} → ${state}`,
      celebrate: target => `${target} أنهى مهمة`,
      broadcast: message => `بث: ${message}`,
      emote: profile => `${profile} عرض تعبيراً`,
      refreshed: 'تم تحديث حالة المكتب',
      unknown: 'حدث المشهد'
    },
    agentModal: {
      config: 'الإعدادات',
      ...
      memoryEmpty: 'لا ملاحظات ذاكرة بعد (MEMORY.md غير موصول في سطح المكتب)',
      userEmpty: 'لا ملف مستخدم بعد (USER.md غير موصول في سطح المكتب)',
      soulEmpty: 'لا يوجد محتوى SOUL بعد',
      soulLoadFailed: 'تعذر تحميل SOUL.md',
      skillsEmpty: 'لا مهارات',
      tasksEmpty: 'لا مهام',
      archiveEmpty: 'لا مهام مؤرشفة',
    ...
    actions: {
      interact: 'تفاعل',
      interactHint: 'أرسل هذا الوكيل لزيارة وكيل آخر متصل',
      interactWith: name => `التفاعل مع ${name}`,
      noOnlineTargets: 'لا يوجد وكلاء متصلون آخرون',
      state: 'الحالة',
      stateHint: 'غيّر حالة هذا الوكيل الحالية (مؤقتة داخل المشهد)',
      working: 'يعمل',
      workingTask: 'يعالج مهمة…',
      thinking: 'يفكر',
      thinkingTask: 'يفكر…',
      online: 'متصل',
      offline: 'غير متصل',
      ...
      emote: 'تعبير',
      emoteHint: 'تشغيل حركة شخصية قصيرة',
      emoteWave: 'تلويح',
      emoteDetermined: 'عزيمة',
      emoteThinking: 'تفكير',
      emoteExcited: 'حماس'
    },
    visitFallback: 'هل لديك لحظة للمزامنة حول أمر ما؟',
    newTaskPrefix: 'مهمة جديدة',
    ambient1: 'مررت لأقول مرحباً.',
    ambient2: 'مزامنة سريعة للتقدم؟',
    ambient3: 'استراحة قهوة؟',
    ambient4: 'خطر ببالي شيء وأردت مشاركته.',
    newTask: {
      title: 'مهمة جديدة',
      name: 'الاسم',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من DechnicAuditor. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء DechnicAuditor...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل DechnicAuditor عن شيء...', 'اطلب من DechnicAuditor تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ DechnicAuditor الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من DechnicAuditor فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث DechnicAuditor...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل DechnicAuditor...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من DechnicAuditor تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من DechnicAuditor جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة DechnicAuditor الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت DechnicAuditor من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط DechnicAuditor الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق DechnicAuditor لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث DechnicAuditor المهمة في نافذته الخاصة ويعيد فتح DechnicAuditor تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح DechnicAuditor بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد DechnicAuditor الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد DechnicAuditor فتح نفسه تلقائيا.',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج DechnicAuditor إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل DechnicAuditor',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من DechnicAuditor CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ DechnicAuditor قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت DechnicAuditor بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك DechnicAuditor Agent',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل DechnicAuditor التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء DechnicAuditor...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل DechnicAuditor',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه DechnicAuditor إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل DechnicAuditor تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل DechnicAuditor تلقائياً',
    ...
    authorizeThere: 'صرّح لـ DechnicAuditor هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ DechnicAuditor هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض DechnicAuditor أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل DechnicAuditor...',
      askRestart: 'اطلب من DechnicAuditor إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث DechnicAuditor عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل DechnicAuditor في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      finishedRestarting: message => `أنهى DechnicAuditor إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على DechnicAuditor إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال DechnicAuditor يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
