...
export const zh: Translations = {
  ...
  install: {
    ...
    oneTimeTitle: 'DechnicAuditor 需要一次性安装',
    ...
    setupChoiceTitle: '设置 DechnicAuditor Desktop',
    setupChoiceDesc: '将此应用连接到你已运行的 DechnicAuditor 网关，或在这台电脑上本地安装 DechnicAuditor。',
    connectExistingTitle: '连接到现有 DechnicAuditor',
    connectExistingShort: '连接现有环境',
    connectExistingDesc: '使用会话令牌或浏览器登录连接远程后端。不会启动本地安装。',
    installLocalTitle: '本地安装 DechnicAuditor',
    installLocalDesc: '下载 DechnicAuditor，创建 Python 环境，并在这台电脑上运行后端。',
    localStartUnavailable: '无法启动本地安装。请重启 DechnicAuditor Desktop 后重试。',
    remoteSetupTitle: '连接到现有 DechnicAuditor',
    remoteSetupDesc: '输入网关 URL。DechnicAuditor Desktop 会检测需要令牌还是浏览器登录。',
    remoteUrlTitle: '网关 URL',
    remoteUrlDesc: '使用 DechnicAuditor 网关的基础 URL；远程地址请包含 https://。',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: '正在检测网关认证方式...',
    probeError: '无法连接到该 DechnicAuditor 网关。',
    identityProvider: '你的身份提供方',
    authTitle: '认证',
    ...
    backToSetup: '返回',
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 DechnicAuditor Agent',
    finishingTitle: '正在收尾',
    failedDesc:
      '某个安装步骤失败。在 Windows 上，如果另一个 DechnicAuditor CLI 或桌面实例正在运行，可能会出现这种情况。请停止正在运行的 DechnicAuditor 实例后重试。可查看下面的详情或 desktop 日志中的完整记录。',
    activeDesc: '这是一次性设置。DechnicAuditor 安装器正在下载依赖并配置你的机器。之后启动会跳过此步骤。',
  ...
  onboarding: {
    headerTitle: '开始设置 DechnicAuditor Agent',
    headerDesc: '连接模型提供方即可开始对话。大多数选项只需一次点击。',
    preparingInstall: 'DechnicAuditor 正在完成安装。首次运行通常不到一分钟。',
    starting: '正在启动 DechnicAuditor…',
    ...
    recommended: '推荐',
    connected: '已连接',
    featuredPitch: '一个订阅，300+ 前沿模型 — 运行 DechnicAuditor 的推荐方式',
