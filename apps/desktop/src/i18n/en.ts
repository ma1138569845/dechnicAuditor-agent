...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      backgroundExited: 'DechnicAuditor background process exited.',
      backgroundExitedDuringStartup: 'DechnicAuditor background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting DechnicAuditor Desktop.',
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by DechnicAuditor when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let DechnicAuditor walk you through the app, dimming the screen and spotlighting each step.',
    ...
    onlyoffice: {
      loading: 'Loading OnlyOffice config…',
      failedLoad: 'Failed to load OnlyOffice config',
      unavailableTitle: 'Desktop config unavailable',
      unavailableDesc: 'This desktop build does not support OnlyOffice config. Update DechnicAuditor Desktop and retry.',
      title: 'OnlyOffice connection',
      intro:
        'Enter your OnlyOffice DocumentServer connection details to open Office files in the WYSIWYG editor. Saving injects the config into the backend automatically — no need to set environment variables at every launch.',
      enabled: 'Enabled',
      disabled: 'Disabled',
      sourceConfig: 'from saved config',
      sourceEnv: 'from launch env',
      envNotice:
        'OnlyOffice is disabled: both the DS URL and the JWT secret are required. When disabled, Office files fall back to the editor_sdk read-only preview + AI editing.',
      secretKeepHint: 'leave empty to keep the saved secret',
      dsUrlTitle: 'DocumentServer URL',
      dsUrlDesc: 'e.g. http://10.10.2.55:8090. Saving enables OnlyOffice mode.',
      secretTitle: 'JWT secret',
      secretDesc: 'The HS256 secret shared with the DocumentServer container (JWT_SECRET).',
      secretPlaceholder: 'Enter the shared secret',
      secretSetPlaceholder: 'Configured (empty keeps it, type to change)',
      callbackHostTitle: 'Callback host',
      callbackHostDesc: 'LAN address the DocumentServer uses to reach this machine. Empty lets the backend auto-detect.',
      callbackHostPlaceholder: 'e.g. 192.168.0.238 (optional)',
      previewPortTitle: 'Preview port',
      previewPortDesc: 'Preview-server port, must match the firewall rule. Empty auto-assigns.',
      previewPortPlaceholder: 'e.g. 39250 (optional)',
      save: 'Save',
      saveAndRestart: 'Save & restart backend',
      clear: 'Clear config',
      restartHint: '“Save” applies on the next backend start; “Save & restart backend” applies immediately.',
      savedTitle: 'Saved',
      savedMessage: 'OnlyOffice config saved; it takes effect on the next backend start.',
      restartingTitle: 'Saved & restarted',
      restartingMessage: 'OnlyOffice config saved and the backend restarted.',
      clearedTitle: 'Cleared',
      clearedMessage: 'OnlyOffice config cleared; Office files will fall back to editor_sdk read-only preview.',
      saveFailed: 'Failed to save OnlyOffice config',
      applyFailed: 'Save or restart failed',
  ...
  knowledge: {
    ...
    createDesc: 'Name a knowledge base, then upload documents to search and cite.',
    nameLabel: 'Name',
    namePlaceholder: 'Energy-audit reports',
    descLabel: 'Description',
    descPlaceholder: 'Optional description',
    systemBases: 'System knowledge bases',
    userBases: 'My knowledge bases',
    system: 'System',
    noDescription: 'No description',
    emptyTitle: 'No knowledge bases yet',
    emptyDesc: 'Create a knowledge base to upload documents and run retrieval.',
    searchPlaceholder: 'Search knowledge bases…',
    deleteConfirm: name => `Delete “${name}”? Documents in this knowledge base will be removed.`,
    deleteDocConfirm: name => `Delete “${name}”?`,
    deleteFolderConfirm: name => `Delete folder “${name}” and its documents?`,
    created: 'Knowledge base created',
    deleted: 'Deleted',
    failedLoad: 'Could not load knowledge bases',
    ...
    folderHint: 'Folders group documents inside this knowledge base.',
    ...
    noDocumentsDesc: 'Upload files to this folder to index them.',
    noChunks: 'No chunks yet. Parsing may still be running.',
    ...
    searchHint: 'Search this knowledge base…',
    searchEmpty: 'Enter a query to retrieve matching chunks.',
    searchNoResults: 'No matching chunks',
    searchAction: 'Search',
    searching: 'Searching…',
    score: 'Score',
    untitled: 'Untitled',
    noWikiTitle: 'No wiki pages',
    noWikiDesc: 'Wiki pages appear after the knowledge base is indexed.',
    statsTotal: 'Documents',
    statsCompleted: 'Completed',
    statsProcessing: 'Processing',
    statsFailed: 'Failed',
    statsOrphaned: 'Orphaned',
    statsSize: 'Total size',
    statusPending: 'Pending',
    statusProcessing: 'Processing',
    statusCompleted: 'Completed',
    statusFailed: 'Failed',
    docsCount: count => `${count} docs`,
    backToList: 'All knowledge bases',
    notFound: 'Knowledge base not found',
    nextPage: 'Next',
    rangeOf: (start, end, total) => `${start}–${end} of ${total}`,
    generate: 'Generate',
    rebuild: 'Rebuild',
    rebuildConfirm: 'Re-vectorize every document in this knowledge base? Running jobs continue; new ones are queued.',
    rebuildQueued: 'Rebuild queued',
    folderWiki: 'Folder wiki',
    bulkWiki: 'Bulk wiki',
    hierarchicalWiki: 'Hierarchical wiki',
    curateApproved: 'Curate approved pages',
    llmConfirmTitle: 'This uses the LLM',
    llmConfirmBody: 'This step calls the language model and may take a while. Continue?',
    actionStarted: 'Started',
    actionFailed: 'Could not start',
    wikiSkipped: 'Wiki already exists — skipped',
    qualityUpdated: 'Quality score updated',
    vectorize: 'Vectorize',
    ...
    wikiConfirmTitle: 'Generate wiki',
    wikiConfirmBody: 'Write wiki pages from this document. Open the Wiki tab when they are ready.',
    wikiCurateAfter: 'Curate after generating',
    wikiCurateAfterHint: 'Then reshape the draft into concept pages. Slower, and calls the model again.',
    textExcerpt: 'Text extract',
    noSummary: 'No summary yet',
    noSummaryDesc: 'Generate a summary from the more menu after the document is indexed.',
    chunkOff: 'Not in search',
    previewTooLarge: 'This file is too large to preview inline.',
    openPipeline: 'Open',
    noPreview: 'No file preview available.',
    searchModeVector: 'Vector',
    searchModeWiki: 'Wiki',
    searchModeGraph: 'Graph',
    searchModeUnified: 'Unified',
    ...
    noGraphDesc: 'Build a graph from a completed document to extract entities and relationships.',
    graphSearch: 'Search entities…',
    graphFit: 'Fit',
    graphHint: 'Scroll to zoom · drag to pan · drag a node to pin it',
    graphNeighbors: 'Connected',
    graphNoSelection: 'Select a node to see its connections.',
    graphOrphan: 'No connections in this view.',
    graphCanvas: 'Knowledge graph',
    graphResize: 'Resize inspector',
    noJobsTitle: 'No jobs',
    noJobsDesc: 'Vectorization and curation jobs will appear here.',
    jobTypeVectorize: 'Vectorize',
    jobTypeCurate: 'Curate',
    selectedCount: n => `${n} selected`,
    bulkDeleteConfirm: 'Delete the selected documents?',
  ...
  office: {
    ...
    status: {
      ...
      hintIdle: 'No active kanban or cron work',
      hintBusy: 'Working a kanban or cron task',
      hintOffline: 'This profile’s messaging gateway is not running',
      hintGatewayOff: 'Messaging gateway is off (desktop chat still works; messaging platforms won’t)'
    },
    ledger: {
      title: 'Task flow',
      filterAll: 'All',
    ...
    activity: {
      visit: (visitor, host) => `${visitor} visited ${host}`,
      tour: (visitor, count) => `${visitor} toured ${count} desks`,
      setState: (profile, state) => `${profile} → ${state}`,
      celebrate: target => `${target} finished a task`,
      broadcast: message => `Broadcast: ${message}`,
      emote: profile => `${profile} played an emote`,
      refreshed: 'Office status refreshed',
      unknown: 'Scene event'
    },
    agentModal: {
      config: 'Config',
      ...
      memoryEmpty: 'No memory notes yet (MEMORY.md not wired in desktop)',
      userEmpty: 'No user profile yet (USER.md not wired in desktop)',
      soulEmpty: 'No SOUL content yet',
      soulLoadFailed: 'Could not load SOUL.md',
      skillsEmpty: 'No skills',
      tasksEmpty: 'No tasks',
      archiveEmpty: 'No archived tasks',
    ...
    actions: {
      interact: 'Interact',
      interactHint: 'Send this agent to visit another online agent',
      interactWith: name => `Interact with ${name}`,
      noOnlineTargets: 'No other online agents',
      state: 'State',
      stateHint: 'Change this agent’s current state (scene-only, temporary)',
      working: 'Working',
      workingTask: 'Working on a task…',
      thinking: 'Thinking',
      thinkingTask: 'Thinking…',
      online: 'Online',
      offline: 'Offline',
      viewProfile: 'View profile',
      setState: 'Set state',
      emote: 'Emote',
      emoteHint: 'Play a short character animation',
      emoteWave: 'Wave',
      emoteDetermined: 'Determined',
      emoteThinking: 'Thinking',
      emoteExcited: 'Excited'
    },
    visitFallback: 'Got a moment to sync on something?',
    newTaskPrefix: 'New task',
    ambient1: 'Just swinging by to say hi.',
    ambient2: 'Quick sync on progress?',
    ambient3: 'Coffee break — join me?',
    ambient4: 'Had an idea — wanted to share.',
    newTask: {
      title: 'New task',
      name: 'Name',
  ...
  install: {
    ...
    probeError: 'Could not reach that DechnicAuditor gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
  ...
  preview: {
    ...
    aiEdit: 'AI edit',
    aiEditHint: 'Tell me how to change it',
    aiEditConfirm: 'Confirm',
    aiEditSelected: count => `${count} line${count === 1 ? '' : 's'} selected`,
    office: {
      loading: 'Loading Office preview…',
      cannotPreview: error => `Cannot preview this Office file: ${error}`,
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'DechnicAuditor gateway is not connected',
  ...
  prompts: {
    ...
    sudoDesc: 'DechnicAuditor needs your sudo password to run a privileged command. It is sent only to your local agent.',
